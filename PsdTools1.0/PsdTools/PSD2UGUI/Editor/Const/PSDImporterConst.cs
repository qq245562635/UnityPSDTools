...
namespace PSDUIImporter
{
    public class PSDImporterConst
    {
        ...
        //字体路径，按需修改
        public const string FONT_FOLDER = "Assets/Tools/PsdTools/Font/";
        public const string FONT_STATIC_FOLDER = "Assets/Tools/PsdTools/Font/StaticFont/";
        public const string FONT_SUFIX = ".ttf";

        //修改资源模板加载路径，不能放在resources目录
        public const string PSDUI_PATH = "Assets/Tools/PsdTools/Template/UI/";
